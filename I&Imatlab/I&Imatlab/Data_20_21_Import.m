...
title('Boxplot of Briar Cliff Discharge','fontsize',22,'interpreter','latex')
...
title('Boxplot of College Garden Discharge','fontsize',22,'interpreter','latex')
xlabel('Precipitation (inches)','fontsize',18,'interpreter','latex')
ylabel('Frequency','fontsize',18,'interpreter','latex')
grid on
grid minor
...
title('Boxplot of Highland Discharge','fontsize',22,'interpreter','latex')
xlabel('Precipitation (inches)','fontsize',18,'interpreter','latex')
ylabel('Frequency','fontsize',18,'interpreter','latex')
grid on
grid minor
...
title('Boxplot of Hilltop Discharge','fontsize',22,'interpreter','latex')
xlabel('Precipitation (inches)','fontsize',18,'interpreter','latex')
ylabel('Frequency','fontsize',18,'interpreter','latex')
grid on
grid minor
